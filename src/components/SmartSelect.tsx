      ...
      {!otherMode ? (
        <div className="relative">
          <button
            ...
            className="w-full input-geometric bg-white flex items-center justify-between text-left font-bold text-slate-800 focus:outline-none focus:ring-2 focus:ring-blue-500/50"
          >

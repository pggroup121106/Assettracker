...
const ROLES = ['IT Admin', 'Admin', 'User'];
...
export default function UserManagement() {
  ...
  // Get current logged-in user information for role based filtering
  ...
  const displayedUsers = useMemo(() => {
    ...
    return users.filter(u => {
      ...
      const sharesLoc = u.locations.some(loc => adminLocs.includes(loc));
      const sharesPlant = u.plants.some(p => adminPlants.includes(p));
      return sharesLoc || sharesPlant;
    });
      ...
      <div className="max-w-5xl mx-auto">
        ...
        {initialLoading && displayedUsers.length === 0 ? (
          ...
          <div className="p-6 bg-gray-50 border border-gray-200 rounded-xl text-center">
            <p className="text-gray-600 mb-3">No users found under your location/plant access.</p>
